...
export function createCommandHandlers(context: CommandHandlerContext): CommandHandlers {
  ...
  return {
    ...
    kubectlGetPods: () => withRuntimeRefresh(() => runKubectlGetPods(runtime())),
    kubectlDescribePod: () => withRuntimeRefresh(() => runKubectlDescribePod(runtime())),
    kubectlGetEvents: () => withRuntimeRefresh(() => runKubectlGetEvents(runtime())),
    kubectlLogs: () => withRuntimeRefresh(() => runKubectlLogs(runtime())),
    kubectlRolloutRestart: () => withRuntimeRefresh(() => runKubectlRolloutRestart(runtime())),
    kubectlRolloutStatus: () => withRuntimeRefresh(() => runKubectlRolloutStatus(runtime())),
