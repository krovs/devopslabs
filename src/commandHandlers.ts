...
import {
  ...
  securityHubGetFindings as runSecurityHubGetFindings,
  securityHubBatchUpdateFindings as runSecurityHubBatchUpdateFindings,
  accessAnalyzerListFindings as runAccessAnalyzerListFindings,
...
import {
  ...
  kafkaConsumerGroupsDescribe as runKafkaConsumerGroupsDescribe,
  logsDescribeLogGroups as runLogsDescribeLogGroups,
  otelcolValidate as runOtelcolValidate,
  promtoolTargets as runPromtoolTargets,
  secretsManagerDescribeSecret as runSecretsManagerDescribeSecret,
  secretsSsmGetParameter as runSecretsSsmGetParameter,
  vaultPolicyRead as runVaultPolicyRead,
  vaultKvGet as runVaultKvGet,
  vaultTokenCapabilities as runVaultTokenCapabilities,
} from "./simulators/ops";
import {
...
export function createCommandHandlers(context: CommandHandlerContext): CommandHandlers {
  ...
  return {
    ...
    vaultPolicyRead: () => withRuntimeRefresh(() => runVaultPolicyRead(runtime(), scenarioId())),
    vaultTokenCapabilities: () => withRuntimeRefresh(() => runVaultTokenCapabilities(runtime(), scenarioId())),
    vaultKvGet: () => withRuntimeRefresh(() => runVaultKvGet(runtime(), scenarioId())),
    ...
    otelcolValidate: () => withRuntimeRefresh(() => runOtelcolValidate(runtime(), scenarioId())),
    kafkaConsumerGroupsDescribe: () => withRuntimeRefresh(() => runKafkaConsumerGroupsDescribe(runtime(), scenarioId())),
    ...
    linuxDfInodes: () => withRuntimeRefresh(() => runLinuxDfInodes(runtime())),
    ...
    linuxSystemctlDaemonReload: () => withRuntimeRefresh(() => runLinuxSystemctlDaemonReload(runtime())),
    ...
    kubectlGetHpa: () => withRuntimeRefresh(() => runKubectlGetHpa(runtime(), scenarioId())),
    kubectlDescribeHpa: () => withRuntimeRefresh(() => runKubectlDescribeHpa(runtime(), scenarioId())),
    ...
    securityHubGetFindings: () => withRuntimeRefresh(() => runSecurityHubGetFindings(runtime(), scenarioId())),
    securityHubBatchUpdateFindings: () => withRuntimeRefresh(() => runSecurityHubBatchUpdateFindings(runtime(), scenarioId())),
    accessAnalyzerListFindings: () => withRuntimeRefresh(() => runAccessAnalyzerListFindings(runtime(), scenarioId())),
