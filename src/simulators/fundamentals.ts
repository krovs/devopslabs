...
export function runKubectlGetPods(runtime: Scenario): string[] {
  runtime.flags.initialized = true;
...
export function runKubectlDescribePod(runtime: Scenario): string[] {
  runtime.flags.validationPassed = true;
  return [
...
export function runKubectlGetEvents(runtime: Scenario): string[] {
...
export function runKubectlLogs(runtime: Scenario): string[] {
...
export function runKubectlRolloutRestart(runtime: Scenario): string[] {
...
export function runKubectlRolloutStatus(runtime: Scenario): string[] {
  const deployment = runtime.files["deployment.yaml"] ?? "";
