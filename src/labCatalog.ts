...
export const scenarioDifficultyTiers: Partial<Record<string, DifficultyTier>> = {
  ...
  azureDevOpsPipelineWrongVariableGroup: "normal",
  ansiblePlaybookWrongHostGroup: "easy",
  ...
  pythonSemgrepHardcodedSecret: "easy",
  npmTransitiveCveAudit: "normal",
  ...
  secHubFindingsTriageSuppress: "normal",
  accessAnalyzerExternalFinding: "normal",
  cloudFormationDriftDetection: "normal",
  cfnStackPolicyDenyUpdate: "hard",
  cfnRollbackFailedContinue: "hard",
  cfnNestedStackParameterMismatch: "normal",
  cfnIamCapabilityMissing: "easy",
  cfnExportImportConflict: "normal",
  cfnStackSetInstanceFailed: "hard",
  linuxServiceLogTriage: "easy",
  linuxDiskInodeFull: "normal",
  linuxSystemdUnitFailed: "normal",
...
const commandOptionsByKind: Record<NonNullable<Scenario["kind"]>, string[]> = {
  ...
  linux: ["ls -la", "cat app.log", "grep ERROR app.log", "journalctl -u web -n 20", "systemctl status web", "df -h", "df -hi", "du --inodes -d 2 /var", "free -m", "ps aux", "top -b -n1", "ss -tulpn", "sudo systemctl daemon-reload", "sudo systemctl restart web", "check", "help"],
  ...
  supplychain: ["syft check release checkout-api:2.5.0", "syft generate checkout-api:2.5.0 -o cyclonedx", "cosign verify ghcr.io/acme/checkout-api:2.5.0", "grype scan checkout-api:2.5.0", "slsa-verifier verify-image ghcr.io/acme/checkout-api:2.5.0", "pip-audit --index-url https://pypi.acme.internal/simple", "check", "help"],
